      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
          <button
            ...
            className="w-full sm:w-auto px-10 py-5 bg-[#B15E41] text-[#FFFFFF] rounded-full text-lg font-medium hover:bg-[#9A4B32] transition-all transform hover:-translate-y-1 shadow-2xl shadow-[#B15E41]/30"
          >
