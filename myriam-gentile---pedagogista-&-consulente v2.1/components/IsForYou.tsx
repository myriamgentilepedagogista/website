      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="bg-[#F0F4EE] p-10 rounded-[2.5rem] border border-[#7B8B6F]/10 flex flex-col h-full">
            ...
            <div className="bg-[#FDF4E3] p-10 rounded-[2.5rem] border border-[#D68C70]/10 flex flex-col h-full">
          ...
          <div className="mt-20 text-center animate-fade-in-up">
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 bg-[#F9F6F1] rounded-full border border-[#EBE7E0]">
              ...
              <span className="text-[10px] uppercase tracking-widest font-bold text-[#6B5E51]">Il primo passo è l'ascolto</span>
            </div>
            ...
            <button
              ...
              className="inline-flex items-center gap-3 px-10 py-5 bg-[#B15E41] text-[#FFFFFF] rounded-full text-lg font-medium hover:bg-[#9A4B32] transition-all transform hover:-translate-y-1 shadow-2xl shadow-[#B15E41]/30"
            >
              Prenota un colloquio conoscitivo <ArrowRight className="w-5 h-5" />
            </button>
            <p className="mt-6 text-xs text-[#A89E92] uppercase tracking-widest">Nessun impegno, solo un incontro per capire come procedere.</p>
          </div>
        </div>
      </div>
    </section>
