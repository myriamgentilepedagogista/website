...
const Contact: React.FC<ContactProps> = ({ onOpenContact }) => {
  const contactInfos = [
    {
      icon: <Mail className="w-5 h-5 text-[#B15E41]" />,
      label: 'Email',
  ...
  return (
    <section id="contact" className="py-24 bg-[#FDFBF7] scroll-mt-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#B15E41]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 -z-10"></div>
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          <div className="animate-fade-in">
            <span className="text-[#B15E41] font-semibold tracking-widest text-xs uppercase mb-4 block">
              Contatti
            </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              {contactInfos.map((info, idx) => (
                <div
                  key={idx}
                  className="flex flex-col p-8 bg-white rounded-[2rem] border border-[#F3F0E9] transition-all hover:shadow-md hover:border-[#B15E41]/20"
                >
                  <div className="w-12 h-12 rounded-2xl bg-[#FDFBF7] flex items-center justify-center mb-5 border border-[#F3F0E9]">
                    {info.icon}
                  </div>
                  <p className="text-xs text-[#A89E92] uppercase tracking-widest font-bold mb-1">
                    {info.label}
                  </p>
          ...
          <div className="relative pt-10">
            ...
            <div className="relative z-10 group">
              <div className="absolute -top-6 -right-6 w-20 h-20 bg-[#B15E41] rounded-full flex items-center justify-center shadow-xl rotate-12 z-20 transition-transform group-hover:scale-110 group-hover:rotate-6">
              ...
              <div className="bg-white p-10 md:p-16 rounded-[3.5rem] shadow-2xl shadow-[#4A3F35]/10 border border-[#F3F0E9] text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#F9F6F1] rounded-full mb-8 border border-[#EBE7E0]">
                  <Sparkles className="w-4 h-4 text-[#B15E41]" />
                ...
                <button
                  ...
                  className="inline-flex items-center gap-4 px-12 py-6 bg-[#B15E41] text-[#FFFFFF] rounded-full text-xl font-medium hover:bg-[#9A4B32] transition-all transform hover:-translate-y-1 shadow-2xl shadow-[#B15E41]/30 w-full md:w-auto"
                >
