          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-12">
            ...
            <div className="flex flex-col items-start md:items-end gap-6 w-full md:w-auto">
              ...
              <div className="flex flex-col items-start md:items-end gap-2 mt-4">
                ...
                <p className="text-[10px] uppercase tracking-widest text-[#A89E92]">
                  Web Design & SEO by <a href="https://www.fgdigitalsystems.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#D68C70] underline transition-colors">www.fgdigitalsystems.com</a>
                </p>
              </div>
            </div>
          </div>
