  ...
  <div className="border-b border-[#EBE7E0] last:border-0">
    ...
    >
      <div className="flex items-center gap-6">
        <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-colors ${isOpen ? 'bg-[#B15E41] text-[#FFFFFF]' : 'bg-[#F9F6F1] text-[#B15E41]'}`}>
          {icon}
        </div>
        <h3 className={`text-2xl font-serif transition-colors ${isOpen ? 'text-[#B15E41]' : 'text-[#4A3F35]'}`}>{title}</h3>
      </div>
      <ChevronDown className={`w-6 h-6 text-[#A89E92] transition-transform duration-300 ${isOpen ? 'rotate-180 text-[#B15E41]' : ''}`} />
    </button>
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-[#B15E41] font-semibold tracking-widest text-xs uppercase mb-4 block">Il percorso</span>
            <h2 className="text-4xl md:text-5xl font-serif text-[#4A3F35]">Formazione ed Esperienza</h2>
            <div className="w-16 h-1 bg-[#B15E41]/20 mx-auto mt-6 rounded-full"></div>
          </div>
          ...
          <div className="bg-white rounded-[3rem] p-4 md:p-8 border border-[#F3F0E9] shadow-sm mb-12">
            ...
            >
              <div className="space-y-8 pl-4">
                <div className="border-l-2 border-[#B15E41]/20 pl-6">
                  <h4 className="font-semibold text-[#4A3F35]">Laurea Magistrale in Scienze Pedagogiche (LM-85)</h4>
                  <p className="text-sm text-[#B15E41]">110/110 Lode | Università degli Studi di Macerata</p>
                ...
                <div className="border-l-2 border-[#B15E41]/20 pl-6">
                  ...
                  <p className="text-sm text-[#B15E41]">106/110 | Università degli Studi di Macerata</p>
                ...
                <div className="border-l-2 border-[#B15E41]/20 pl-6">
                  ...
                  <p className="text-sm text-[#B15E41]">80/100 | Liceo "A.G. Roncalli", Manfredonia (FG)</p>
                </div>
              </div>
            </AccordionItem>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 pl-4">
                {[
                  ...
                  <div key={idx} className="flex gap-3 text-sm border-b border-[#F3F0E9] pb-2">
                    <Award className="w-4 h-4 text-[#B15E41] shrink-0 mt-0.5" />
                    <span>{course}</span>
                  </div>
                ))}
              </div>
            ...
            >
              <div className="space-y-12 pl-4">
                {/* Categoria 1 */}
                <div>
                  <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-[#B15E41] mb-6 flex items-center gap-2">
                    <div className="h-px w-8 bg-[#B15E41]/30"></div>
                ...
                <div>
                  ...
                  <div className="space-y-6 pl-4 border-l border-[#EBE7E0]">
                    <div className="relative pl-6">
                      <div className="absolute top-1.5 left-[-5.5px] w-2.5 h-2.5 rounded-full bg-[#B15E41]"></div>
          ...
          <div className="text-center">
             <Link to="/esperienza" className="inline-flex items-center gap-2 bg-white px-10 py-4 rounded-full border border-[#EBE7E0] text-[#B15E41] font-medium text-sm group hover:bg-[#F9F6F1] transition-all shadow-sm hover:underline underline-offset-8">
