...
import ConsulenzaGenitorialePage from './pages/ConsulenzaGenitorialePage';
import CoordinamentoPedagogicoPage from './pages/CoordinamentoPedagogicoPage';
import TutoraggioSpecialisticoPage from './pages/TutoraggioSpecialisticoPage';
    ...
    <div className="min-h-screen bg-[#FDFBF7]" id="top">
      ...
      <main>
        <Routes>
          ...
          <Route path="/servizi/consulenza-genitoriale" element={<ConsulenzaGenitorialePage onOpenContact={openContact} />} />
          <Route path="/servizi/coordinamento-pedagogico" element={<CoordinamentoPedagogicoPage onOpenContact={openContact} />} />
          <Route path="/servizi/tutoraggio-specialistico" element={<TutoraggioSpecialisticoPage onOpenContact={openContact} />} />
