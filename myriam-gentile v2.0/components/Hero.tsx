          ...
          <div className="w-full lg:w-[55%] text-center lg:text-left order-1">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              ...
              <a
                ...
                className="w-full sm:w-auto px-8 py-4 bg-white/80 backdrop-blur-sm border border-[#EBE7E0] text-[#4A3F35] rounded-full text-base font-medium hover:bg-white transition-all transform hover:-translate-y-0.5 shadow-sm active:scale-95"
              >
                Scopri chi sono
              </a>
            </div>
