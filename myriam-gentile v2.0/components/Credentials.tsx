      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
             <Link to="/esperienza" className="inline-flex items-center gap-2 bg-[#96472D] px-10 py-4 rounded-full border border-[#96472D] text-[#FFFFFF] font-medium text-sm group hover:bg-[#803C26] transition-all shadow-lg transform hover:-translate-y-1">
