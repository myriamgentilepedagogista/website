...
const Footer: React.FC<FooterProps> = ({ onOpenContact }) => {
  ...
  return (
    <>
      <footer className="py-20 pb-32 md:pb-20 bg-[#FDFBF7] border-t border-[#EBE7E0]">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start gap-12">
            <div className="max-w-md">
              ...
              <div className="text-[11px] text-[#5A5046] leading-relaxed uppercase tracking-widest bg-white p-4 rounded-xl border border-[#EBE7E0]">
            ...
            <div className="flex flex-col items-start md:items-end gap-6 w-full md:w-auto">
              <div className="flex flex-wrap gap-8 text-sm font-medium">
                <a href="https://www.linkedin.com/in/myriam-gentile-012586196/" target="_blank" rel="noopener noreferrer" className="text-[#4A3F35] hover:text-[#96472D] transition-colors">LinkedIn</a>
                <Link 
                  href="/chi-sono" 
                  className="text-[#4A3F35] hover:text-[#96472D] transition-colors"
                >
                  Chi Sono
                </Link>
                <Link 
              ...
              <div className="flex flex-wrap gap-6 mt-4">
                <button 
                  ...
                  className="text-[10px] uppercase tracking-widest text-[#6B6155] hover:text-[#96472D] transition-colors"
                >
                  Privacy Policy
                </button>
                <button 
              ...
              <div className="flex flex-col items-start md:items-end gap-2 mt-4">
                ...
                <p className="text-[10px] uppercase tracking-widest text-[#6B6155]">
                  Web Design & SEO by <a href="https://www.fgdigitalsystems.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#96472D] underline transition-colors">www.fgdigitalsystems.com</a>
                </p>
              </div>
            </div>
          </div>
