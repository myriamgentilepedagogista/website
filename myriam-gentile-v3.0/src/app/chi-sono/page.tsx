...
export const metadata: Metadata = {
  title: 'Chi Sono | Myriam Gentile - Pedagogista a Civitanova Marche',
  description: 'Scopri la storia e l\'approccio Meraki della Dott.ssa Myriam Gentile. Pedagogia e neuroscienze al servizio dell\'educazione.',
  alternates: {
    canonical: 'https://myriamgentilepedagogista.com/chi-sono',
  },
};
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-8 text-[#6B5E51] text-lg font-light leading-relaxed">
              ...
              <section>
                ...
                <div className="mt-6">
                  <Link href="/servizi" className="text-[#D68C70] hover:underline font-medium">Scopri nel dettaglio i miei servizi →</Link>
                </div>
              </section>
            ...
            <div className="mt-24 pt-12 border-t border-[#F3F0E9]">
              ...
              <div className="flex flex-wrap gap-x-12 gap-y-6">
                ...
                <Link href="/esperienza" className="text-[#4A3F35] hover:text-[#D68C70] font-serif text-xl transition-colors flex items-center gap-2 group">
