...
const Contact: React.FC<ContactProps> = ({ onOpenContact }) => {
  ...
  return (
    <section id="contact" className="py-24 bg-[#FDFBF7] scroll-mt-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#D68C70]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 -z-10"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#7B8B6F]/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 -z-10"></div>
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
              {contactInfos.map((info, idx) => (
                <div
                  key={idx}
                  className="flex flex-col p-8 bg-white rounded-[2rem] border border-[#F3F0E9] transition-all hover:shadow-md hover:border-[#D68C70]/20"
                >
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-3xl border border-[#F3F0E9] max-w-lg shadow-sm">
              <div className="w-10 h-10 rounded-full bg-[#7B8B6F]/10 flex items-center justify-center shrink-0">
                <Info className="w-5 h-5 text-[#7B8B6F]" />
              </div>
              <div>
          ...
          <div className="relative pt-10">
            {/* The Contact Action Card - Replaces inline form */}
            <div className="relative z-10 group">
              <div className="absolute -top-6 -right-6 w-20 h-20 bg-[#D68C70] rounded-full flex items-center justify-center shadow-xl rotate-12 z-20 transition-transform group-hover:scale-110 group-hover:rotate-6">
              ...
              <div className="bg-white p-10 md:p-16 rounded-[3.5rem] shadow-2xl shadow-[#4A3F35]/10 border border-[#F3F0E9] text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#F9F6F1] rounded-full mb-8 border border-[#EBE7E0]">
                  <Sparkles className="w-4 h-4 text-[#D68C70]" />
                  <span className="text-[10px] uppercase tracking-widest font-bold text-[#6B5E51]">Iniziamo da qui</span>
                </div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-4 px-12 py-6 bg-[#D68C70] text-white rounded-full text-xl font-medium hover:bg-[#C27A5F] transition-all transform hover:-translate-y-1 shadow-2xl shadow-[#D68C70]/30 w-full md:w-auto"
                >
              ...
              <div className="absolute inset-0 bg-[#7B8B6F]/5 rounded-[3.5rem] translate-y-6 translate-x-4 -z-10 transition-transform group-hover:translate-x-6"></div>
            </div>

            {/* Google Map Section */}
            <div className="mt-16 rounded-[2.5rem] overflow-hidden border border-[#F3F0E9] shadow-lg h-72 grayscale-[0.5] hover:grayscale-0 transition-all duration-700">
              <iframe
