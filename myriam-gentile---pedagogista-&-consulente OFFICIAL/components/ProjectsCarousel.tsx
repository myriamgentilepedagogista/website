      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-6xl mx-auto relative group">
          ...
          <div className="relative aspect-[16/9] md:aspect-[21/9] overflow-hidden rounded-[3rem] shadow-2xl bg-[#F9F6F1]">
            ...
            {/* Navigation Arrows */}
            <button onClick={prev} className="absolute left-6 top-1/2 -translate-y-1/2 z-10 w-14 h-14 bg-white/90 backdrop-blur rounded-full flex items-center justify-center text-[#4A3F35] shadow-lg hover:bg-white transition-all opacity-0 group-hover:opacity-100">
              <ChevronLeft className="w-6 h-6" />
            </button>
            <button onClick={next} className="absolute right-6 top-1/2 -translate-y-1/2 z-10 w-14 h-14 bg-white/90 backdrop-blur rounded-full flex items-center justify-center text-[#4A3F35] shadow-lg hover:bg-white transition-all opacity-0 group-hover:opacity-100">
