...
import { ChevronDown, GraduationCap, Briefcase, Award, BookOpen } from 'lucide-react';
...
const AccordionItem: React.FC<{ title: string; children: React.ReactNode; isOpen: boolean; onClick: () => void; icon: React.ReactNode }> = ({ title, children, isOpen, onClick, icon }) => (
  <div className="border-b border-[#EBE7E0] last:border-0">
    ...
    <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? 'max-h-[3500px] opacity-100 pb-12' : 'max-h-0 opacity-0'}`}>
      <div className="pl-18 text-[#6B5E51] font-light leading-relaxed">
        {children}
      </div>
    </div>
  </div>
    ...
    <section id="experience" className="py-24 bg-[#FDFBF7] scroll-mt-24">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-[3rem] p-4 md:p-8 border border-[#F3F0E9] shadow-sm">
