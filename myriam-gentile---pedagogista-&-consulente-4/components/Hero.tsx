    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-28 pb-20 md:pt-20 md:pb-0 overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-lg md:text-xl text-[#6B5E51] max-w-2xl mx-auto mb-14 leading-relaxed font-light">
          Accompagno le persone a ritrovare la bellezza nelle relazioni in famiglia, a scuola e nel lavoro educativo.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
          <a
            ...
            className="w-full sm:w-auto px-10 py-5 bg-[#D68C70] text-white rounded-full text-lg font-medium hover:bg-[#C27A5F] transition-all transform hover:-translate-y-1 shadow-2xl shadow-[#D68C70]/30"
          >
          ...
          <a
            ...
            className="w-full sm:w-auto px-10 py-5 bg-white text-[#4A3F35] border border-[#EBE7E0] rounded-full text-lg font-medium hover:bg-[#F9F6F1] transition-all"
          >
            Scopri chi sono
          </a>
        </div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce opacity-40 hidden sm:block">
        <ArrowDown className="w-7 h-7 text-[#4A3F35]" />
      </div>
    </section>
  );
};
