          ...
          <div className="md:w-3/5 p-8 md:p-12 flex flex-col justify-center text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              <a 
                ...
                className="inline-flex items-center gap-3 bg-[#1DB954] text-black px-8 py-4 rounded-full font-medium hover:bg-[#1ed760] transition-all shadow-md hover:shadow-lg active:scale-95 text-sm md:text-base"
              >
