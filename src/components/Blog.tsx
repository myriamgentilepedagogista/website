  ...
  },
  {
    ...
    content: (
      <div className="space-y-10 text-lg font-light leading-relaxed">
        ...
        <p className="mt-8">
          Compresa la differenza, è importante ricordare che un buon professionista sa quando inviare l'utente a un altro collega. Se hai dubbi sulla situazione di tuo figlio, un primo colloquio informativo nel mio studio di <Link href="/servizi" className="text-[#A05A3E] hover:underline">Civitanova Marche</Link> può aiutarti a fare chiarezza.
        </p>
      </div>
    )
  },
  {
    ...
    content: (
      <div className="space-y-10 text-lg font-light leading-relaxed">
        ...
        <p>
          Lavoriamo molto sulla <strong>consapevolezza fonologica</strong>, sulla grafomotricità e sull'approccio ludico all'apprendimento. Ma soprattutto, lavoriamo sulle emozioni legate all'errore. Insegniamo ai bambini che l'errore non è un fallimento, ma un'informazione preziosa per il cervello. Questo approccio è fondamentale per chi ha un <Link href="/servizi/tutoraggio-specialistico" className="text-[#A05A3E] font-medium hover:underline">Tutoraggio Specialistico</Link> in corso, induve la motivazione è spesso fragile.
        </p>
        ...
        <p>
          Ogni percorso con il minore prevede momenti di confronto con i genitori. Non si può cambiare il percorso di un ragazzo senza coinvolgere il sistema in cui vive. Insieme, analizziamo i PDP (Piani Didattici Personalizzati) e cerchiamo di uniformare lo stile comunicativo tra casa e scuola. Se desideri un supporto per tuo figlio a <Link href="/#contact" className="text-[#A05A3E] hover:underline">Civitanova Marche</Link>, il mio studio offre percorsi individualizzati che mettono al centro il benessere del ragazzo e la serenità dei genitori.
        </p>
      </div>
    )
  },
  {
    ...
    content: (
      <div className="space-y-10 text-lg font-light leading-relaxed">
        ...
        <p>
          Per i ragazzi, l'attività pratica si declina nel potenziamento cognitivo e nel tutoraggio. Non facciamo "compiti", ma laboratori di <strong>metodo di studio</strong>. Questo significa analizzare come il ragazzo legge, come memorizza, come organizza il diario e il tempo libero. Potete trovare maggiori dettagli nella pagina dedicata ai <Link href="/servizi" className="text-[#A05A3E] hover:underline">miei servizi</Link>.
        </p>
        ...
        <p>
          In sintesi, l'agire pedagogico è un agire trasformativo. Non ci accontentiamo di osservare la realtà, ma lavoriamo costantemente per migliorarla, un passo educativo alla volta. Ti aspetto nel mio studio a <Link href="/#contact" className="text-[#A05A3E] hover:underline">Civitanova Marche</Link> per scoprire cosa possiamo fare, in pratica, per la tua situazione.
        </p>
      </div>
    )
  }
    ...
    <section id="blog" className="py-24 bg-[#FDFBF7] scroll-mt-24">
      ...
      <div className="container mx-auto px-6">
          ...
          {articles.slice(0, 3).map((article, idx) => (
            <div key={idx} className="bg-white rounded-[2.5rem] border border-[#F3F0E9] overflow-hidden flex flex-col group hover:shadow-xl transition-all">
              <div className="p-8 flex flex-col h-full">
                ...
                <Link href={`/blog/${article.slug}`} className="inline-flex items-center gap-2 text-[#A05A3E] font-semibold text-sm group/btn hover:underline underline-offset-4">
        ...
        <div className="mt-16 text-center">
          <Link href="/blog" className="inline-flex items-center gap-2 bg-white px-10 py-4 rounded-full border border-[#EBE7E0] text-[#A05A3E] font-medium text-sm group hover:bg-[#F9F6F1] transition-all shadow-sm hover:underline underline-offset-8">
