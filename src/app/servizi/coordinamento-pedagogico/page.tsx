...
export default function CoordinamentoPedagogicoPage() {
  ...
  return (
    <div className="pt-32 pb-24 bg-[#FDFBF7] min-h-screen">
      ...
      <BreadcrumbJsonLd items={[
        ...
        { name: 'Coordinamento Pedagogico', url: `${siteUrl}/servizi/coordinamento-pedagogico` }
      ]} />
      ...
      <div className="container mx-auto px-6">
        ...
        <Link href="/servizi" className="inline-flex items-center gap-2 text-[#A89E92] hover:text-[#7B8B6F] transition-colors mb-12 group text-sm">
          ...
          <section className="mb-24">
            <div className="bg-[#F0F4EE] p-12 rounded-[4rem] border border-[#7B8B6F]/10 flex flex-col md:flex-row items-center gap-12">
               ...
               <div>
                 ...
                 <Link href="/esperienza" className="inline-flex items-center gap-2 px-8 py-3 bg-[#7B8B6F] text-white rounded-full font-bold hover:bg-[#6A7A5E] transition-all">
