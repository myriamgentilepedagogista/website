...
export const metadata: Metadata = {
  ...
  description: 'Consulenza genitoriale, coordinamento pedagogico 0-6 e tutoraggio specialistico DSA/BES. Scopri i percorsi educativi della Dott.ssa Myriam Gentile.',
  alternates: {
    canonical: 'https://myriamgentilepedagogista.com/servizi',
  },
};
      ...
      <div className="container mx-auto px-6">
          ...
          <div className="group bg-white rounded-[3.5rem] border border-[#F3F0E9] overflow-hidden hover:shadow-2xl transition-all duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-12 md:p-16 bg-[#B15E41] text-white flex flex-col justify-center">
                ...
                <Link href="/servizi/consulenza-genitoriale" className="inline-flex items-center gap-2 text-white font-bold hover:underline">
          ...
          <div className="group bg-white rounded-[3.5rem] border border-[#F3F0E9] overflow-hidden hover:shadow-2xl transition-all duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-12 md:p-16 bg-[#7B8B6F] text-white flex flex-col justify-center lg:order-2">
                ...
                <Link href="/servizi/coordinamento-pedagogico" className="inline-flex items-center gap-2 text-white font-bold hover:underline">
                  Approfondisci il servizio <ArrowRight className="w-5 h-5" />
                </Link>
              </div>
          ...
          <div className="group bg-white rounded-[3.5rem] border border-[#F3F0E9] overflow-hidden hover:shadow-2xl transition-all duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-12 md:p-16 bg-[#4A3F35] text-white flex flex-col justify-center">
                ...
                <Link href="/servizi/tutoraggio-specialistico" className="inline-flex items-center gap-2 text-white font-bold hover:underline">
                  Approfondisci il servizio <ArrowRight className="w-5 h-5" />
                </Link>
              </div>
              <div className="p-12 md:p-16 flex flex-col justify-center">
        ...
        <div className="mt-32 pt-12 border-t border-[#F3F0E9]">
          ...
          <div className="flex flex-wrap gap-x-12 gap-y-6">
            <Link href="/faq" className="text-[#4A3F35] hover:text-[#B15E41] font-serif text-xl transition-colors flex items-center gap-2 group">
              Domande Frequenti <ArrowUpRight className="w-4 h-4 opacity-50 group-hover:opacity-100 transition-all" />
            </Link>
            <Link href="/blog" className="text-[#4A3F35] hover:text-[#B15E41] font-serif text-xl transition-colors flex items-center gap-2 group">
              Spazio Pedagogico <ArrowUpRight className="w-4 h-4 opacity-50 group-hover:opacity-100 transition-all" />
            </Link>
            <Link href="/chi-sono" className="text-[#4A3F35] hover:text-[#B15E41] font-serif text-xl transition-colors flex items-center gap-2 group">
