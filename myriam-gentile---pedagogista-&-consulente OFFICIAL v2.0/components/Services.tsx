    ...
    <ul className="space-y-4 mt-auto">
      {items.map((item, idx) => (
        <li key={idx} className="flex items-start gap-3 text-sm text-[#4A3F35]">
          <span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#D68C70] shrink-0"></span>
    ...
    <section id="services" className="py-24 bg-[#FDFBF7] scroll-mt-24">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mb-20">
          <span className="text-[#D68C70] font-semibold tracking-[0.2em] text-[10px] uppercase mb-4 block">Aree di intervento</span>
        ...
        <div className="mt-12 flex justify-end">
          <Link to="/servizi" className="inline-flex items-center gap-2 text-[#D68C70] font-medium text-sm group hover:underline underline-offset-8 transition-all">
