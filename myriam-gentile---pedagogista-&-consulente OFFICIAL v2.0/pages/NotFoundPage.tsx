  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FDFBF7] px-6">
      <div className="text-center max-w-lg">
        ...
        <Link 
          to="/" 
          className="inline-flex items-center gap-3 px-10 py-5 bg-[#4A3F35] text-white rounded-full font-medium hover:bg-[#3A322A] transition-all transform hover:-translate-y-1 shadow-xl"
        >
