          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="p-4 md:p-8 space-y-8">
              ...
              <p className="text-[#6B5E51] text-lg font-light leading-relaxed">
                Essere genitori è un mestiere complesso che si impara sul campo. La consulenza pedagogica offre una "lente" diversa: aiuta a leggere i bisogni profondi dietro i comportamenti dei figli, offrendo strumenti basati sulle neuroscienze per gestire la quotidianità con maggiore serenità.
              </p>
